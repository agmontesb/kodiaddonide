...
class menuThreads:
    ...
    def __init__(self):
        ...
        self.modSourceCode = {}
        self.parseThreads = {
                            'rootmenu': {'name': 'rootmenu', 'params': {}, 'type': 'list'},
                            'media': {'name': 'media', 'params': {}, 'type': 'thread'},                             
                             }
    ...
    def createThread(self, iType = 'list', name = 'defaultName', menuId = '', **kwargs ):
        ...
        self.setThreadParams(menuId, kwargs.get('params', {}))
        if iType == 'list':
    ...
    def existsThread(self, threadId):
            return self.parseThreads.has_key(threadId) if threadId else False
    ...
    def getThreadParam(self, threadId, paramStr):
        ...
        return params.get(paramStr, None)
...
#                 toAppend = self.getLinkStream(nxtThreadId)
    ...
    def getLinks(self, threadId, nodeLst = None):
        ...
        for nxtThreadId in self.getChildren(threadId):
    ...
    def getDotPath(self, threadId):
        if self.existsThread(threadId) == -1: return -1
        dotPath = []
        while 1:
