...
class vertRadioMenu(tk.Frame):
    def __init__(self, master = None, xmlFile = 'addonIdeSettingFile.xml'):
    ...
    def selOption(self, ene = None):
        ...
        if self.rightPane: self.rightPane.changesettings(selPane)
...
class settingsDisplay(tk.Frame):
    def __init__(self, master = None, xmlFile = 'addonIdeSettingFile.xml', nonDefaultValues = None):
        tk.Frame.__init__(self, master)
