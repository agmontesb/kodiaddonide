...
<settings>
  <category label="Widgets types">
    ...
    <setting id="addon_ipaddress" type="ipaddress" label ="type ipaddress" default="5"/>
...
#     fileObject = r'C:\Users\Alex Montes Barrios\AppData\Roaming\Kodi\addons\script.module.urlresolver\resources\settings.xml'
#     fileObject = r'C:\Users\Alex Montes Barrios\AppData\Roaming\Kodi\addons\plugin.video.genesis\resources\settings.xml'
    Root = tk.Tk()
#     Root.withdraw()
#     Root.resizable(0, 0)
